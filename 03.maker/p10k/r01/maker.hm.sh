...
#SBATCH -o slurm-p10k-hm-maker-%j.err
#SBATCH -J p10k.maker.hm
#SBATCH -t 2-00:00:00
#SBATCH --qos=c2022
...
/ibex/scratch/bougous/kaust_research/babili/millet/apps/mpich-3.3.2/bin/mpiexec -hosts=$SLURM_JOB_NODELIST -n 200 /ibex/scratch/bougous/kaust_research/babili/millet/apps/maker-3.01.03/bin/maker -c 1 -base p10k_hm -fix_nucleotides  maker_opts_hm.r01.ctl maker_bopts.ctl maker_exe.ctl
